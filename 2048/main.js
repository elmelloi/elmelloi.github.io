...
var game={
    ...
    updateView:function(){
        ...
        var bestRecord = document.getElementById("best");
        bestRecord.innerHTML = this.best;
        ...
        if(this.isGameOver()){
            ...
            var record = this.score;
            var div=document.getElementById("gameOver");
            var finalSocre=document.getElementById("finalScore");
            finalSocre.innerHTML = record;
            if (record > game.best) {
                game.best = record;
                bestRecord.innerHTML = game.best;
            }
...
window.onload=function(){//事件处理函数
    game.start();
    var restart = document.getElementsByClassName("restart-button");
